...
def gradient_descent_reg(data, lamb_da, max_iter=MAX_ITER, rho=RHO, epsilon=EPSILON):
    ...
    for i in range(0, max_iter):
        ...
        new_theta, new_dir = descent_v2(xtx, xty, curr_theta, rho, lamb_da)
...
def descent_v2(xtx, xty, curr_theta, rho, lamb_da):
    new_dir = 2 * np.matmul(xtx, curr_theta) - xty + 2 * lamb_da * curr_theta
    # print(new_dir)
